      ...
      <div class="row mt-3">
        ...
        @auth
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p><a href="/perfil" class="text-reset"><i class="fas fa-user me-2"></i>Mi Perfil</a></p>
            <p><a href="/carrito" class="text-reset"><i class="fas fa-shopping-cart me-2"></i>Mi Carrito</a></p>
            <p><a href="/mis-compras" class="text-reset"><i class="fas fa-box me-2"></i>Mis Compras</a></p>
          </div>
        @endauth
        ...
        <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <p><i class="fas fa-home me-3"></i> Corrientes Capital</p>
